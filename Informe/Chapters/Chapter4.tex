...
En este ejemplo se usaron los niveles de seguridad que muestra la Figura 19. En ella se puede observar a modo de comentario la representación gráfica del orden generado.\par
...
La excepción de la Figura 21 hace que se ignore el flujo del \textit{device ID} del usuario al \textit{Log}.\par
...
Los resultados obtenidos (Figura 23) muestran que no se producen flujos de información que viole los niveles de seguridad. Además muestra el menor nivel posible, con respecto a los niveles de seguridad, a cada categoría que no tenían nivel asignado.\par
